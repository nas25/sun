...
if(isset($_GET['login']) and isset($_GET['pass']) and !isset($_COOKIE['id']))
{
	...
	{
		echo 'вы пропустили логин  или пароль';
	}
	else
	{
...
<title>Smac.ru.com</title> 
<link href="/public_html/smac.ru.com/css/style.css" rel="stylesheet" type="text/css"> 
</head> 
<style type="text/css">
	* {
	margin: 0;
...
<div id="poisk"><h3>Авторизация</h3>
<br>
<?
if(!isset($_COOKIE['id']))
{
