...
$obkuz = $_GET['obkuz']; 
$obkuz1 = $_GET['obkuz1']; 
$query = mysql_query("SELECT * FROM gruz WHERE `dateotgruz` LIKE '%$dateotgruz%' OR `gorot` LIKE '%$gorot%' OR `strot` LIKE '%$strot%' OR `gornaz` LIKE '%$gornaz%' OR `ves` LIKE '%$ves%' OR `obgruz` LIKE '%$obgruz%' OR `obgruz1` LIKE '%$obkuz1%'") or die(mysql_error()); 
